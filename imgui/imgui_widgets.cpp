...
bool ImGui::InputFloat5(const char* label, float v[5], const char* format, ImGuiInputTextFlags flags)
{
    return InputScalarN(label, ImGuiDataType_Float, v, 5, NULL, NULL, format, flags);
}
